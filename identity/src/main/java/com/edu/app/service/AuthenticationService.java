...
import com.edu.app.dto.request.RefreshRequest;
...
import com.edu.app.repository.InvalidtedTokenRepository;
...
public class AuthenticationService {
    ...
    private String generateToken(User user) {
        ...
        JWTClaimsSet jwtClaimsSet = new JWTClaimsSet.Builder()
                ...
                .build();
        log.info("inpiration time: {}",jwtClaimsSet.getExpirationTime());
